    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs animate-in fade-in duration-200">
      ...
      >
        <button
          onClick={handleClose}
          aria-label="Đóng"
          className="absolute top-4 right-4 w-9 h-9 rounded-full bg-[#f1f5f9] hover:bg-[#e2e8f0] text-[#475569] flex items-center justify-center transition-colors cursor-pointer"
        >
        ...
        {submitState === 'success' ? (
          <div className="text-center py-8 space-y-4 animate-in zoom-in-95 duration-200">
            ...
            <button
              onClick={handleClose}
              className="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl btn-3d-blue text-white text-[13.5px] font-bold cursor-pointer"
            >
              Đóng
            </button>
          </div>
          ...
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                <div>
                  <label className="block text-[12px] font-semibold text-[#0f172a] mb-1">
                    Tên thiết bị / Model <span className="text-[#bb0112]">*</span>
                  </label>
                  <div className="relative">
                    <span className="material-symbols-outlined absolute left-3 top-2.5 text-[#475569] text-[18px]">
                      biotech
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2.5 rounded-xl bg-[#f1f5f9] text-[13.5px] text-[#0f172a] focus:outline-none focus:bg-white focus:ring-2 focus:ring-[#006194] border border-[#e2e8f0] cursor-pointer"
                  >
              ...
              <div>
                <label className="block text-[12px] font-semibold text-[#0f172a] mb-1">
                  Mô tả sự cố <span className="text-[#bb0112]">*</span>
                </label>
                <textarea
                  rows={3}
                  required
