    ...
    <div className="w-full bg-medical-grid-3d py-4 sm:py-6 lg:py-7">
      <div className="max-w-[1320px] mx-auto px-4 sm:px-8 xl:px-12 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
          <div className="lg:col-span-6 rounded-xl overflow-hidden card-3d p-2 bg-white border border-[#cbd5e1]">
            <img
              src={COMPANY_INFO.aboutImage}
              alt="Đội ngũ chuyên gia Trí Việt Phát"
              className="w-full h-[320px] sm:h-[360px] object-cover rounded-lg"
            />
          </div>
          <div className="lg:col-span-6 space-y-4">
            <div className="bg-white p-5 sm:p-6 rounded-lg card-3d space-y-2.5">
              <span className="text-[12px] font-bold text-[#006194] inline-block">
                Hành Trình 16+ Năm
              </span>
            ...
            <div className="grid grid-cols-2 gap-3.5">
              <div className="bg-white p-4 rounded-lg card-3d-subtle border border-[#bae6fd]">
              ...
              <div className="bg-white p-4 rounded-lg card-3d-subtle border border-[#e2e8f0]">
                <div className="flex items-center gap-1.5 text-[#006194] mb-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
          <div className="bg-white p-6 rounded-lg card-3d flex flex-col h-full space-y-3">
            <div className="w-12 h-12 rounded-xl bg-[#f1f5f9] text-[#475569] flex items-center justify-center shrink-0 shadow-xs">
        ...
        {/* Business Activities */}
        <div className="bg-white p-5 sm:p-6 rounded-lg card-3d space-y-4">
        ...
        <div className="p-6 sm:p-8 rounded-xl bg-linear-to-r from-[#003d66] via-[#00517d] to-[#003865] text-white flex flex-col sm:flex-row items-center justify-between gap-6 shadow-[0_12px_32px_rgba(0,60,120,0.25),inset_0_1px_1px_rgba(255,255,255,0.25)] border border-[#006194]/40">
