        ...
        <div className="max-w-[1720px] mx-auto px-4 sm:px-8 xl:px-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 items-stretch">
            {filteredFeaturedProducts.map((prod) => (
              ...
              >
                <div className="relative bg-linear-to-b from-[#f8fafc] to-[#f1f5f9] p-4 flex items-center justify-center aspect-[4/3] min-h-0 overflow-hidden shrink-0 border-b border-[#e2e8f0]/80">
